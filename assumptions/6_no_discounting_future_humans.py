"""Assumption 6 — no discounting of future humans.
...
`future_discount_ci` (added by assumption 5, a 90% CI with mean ~0.01) to
...
is untouched: assumption 5's factor still multiplies every future-facing org,
...
def future_discount_ci():
    """PARAMETER CHANGED: assumption 5 gave a 90% CI with mean ~0.01; the
